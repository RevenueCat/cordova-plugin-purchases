...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 19.3.1 (#1071) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 19.3.0 (#1065) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 19.2.0 (#1063) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `fc64a1a` to `9f7a03e` (#1070) via dependabot[bot] (@dependabot[bot])
* Auto-merge PHC bump PRs (#1069) via Álvaro Brey (@AlvaroBrey)
* Bump fastlane-plugin-revenuecat_internal from `6db1da0` to `fc64a1a` (#1068) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.240.0 to 2.240.1 (#1067) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.239.0 to 2.240.0 (#1064) via dependabot[bot] (@dependabot[bot])
* ci: approve the release hold automatically when the release PR is approved (#1061) via Álvaro Brey (@AlvaroBrey)

## 8.2.2
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 19.0.0 (#1059) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.38.0 (#1058) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### ✨ New Features
* feat: add setOnesignalUserID for OneSignal v11+ (#1020) via Cesar de la Vega (@vegaro)
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.32.1 (#1036) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.31.0 (#1033) via RevenueCat Git Bot (@RCGitBot)
* [RENOVATE] Update dependency revenuecat to v4.6.0 (#1031) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.30.1 (#1030) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.30.0 (#1029) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.29.0 (#1022) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Update sdks-common-config orb to v4.6.1 (#1037) via Antonio Pallares (@ajpallares)
* Bump fastlane-plugin-revenuecat_internal from `7fbbe66` to `7dd9ab9` (#1034) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.237.0 to 2.238.0 (#1032) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `b4e1e7f` to `7fbbe66` (#1028) via dependabot[bot] (@dependabot[bot])

## 8.0.14
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.27.0 (#1019) via RevenueCat Git Bot (@RCGitBot)
  * [iOS 5.82.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.82.0)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `dd577ee` to `b4e1e7f` (#1026) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `3421c88` to `dd577ee` (#1023) via dependabot[bot] (@dependabot[bot])
* Bump danger from 9.6.0 to 9.6.1 (#1024) via dependabot[bot] (@dependabot[bot])

## 8.0.13
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.26.0 (#1016) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency revenuecat to v4.5.1 (#1014) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `d392939` to `3421c88` (#1017) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `b52fca5` to `d392939` (#1012) via dependabot[bot] (@dependabot[bot])

## 8.0.12
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.22.2 (#1007) via RevenueCat Git Bot (@RCGitBot)
...
* [RENOVATE] Update dependency revenuecat to v4.5.0 (#1008) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `9b928b6` to `b52fca5` (#1009) via dependabot[bot] (@dependabot[bot])
* chore: bump fastlane-plugin-revenuecat_internal to unblock hybrid bumps (#1006) via Antonio Pallares (@ajpallares)

## 8.0.11
## RevenueCat SDK
### 📦 Dependency Updates
* [RENOVATE] Update dependency revenuecat to v4 (#1002) via RevenueCat Git Bot (@RCGitBot)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.21.0 (#1000) via RevenueCat Git Bot (@RCGitBot)
  * [Android 10.13.0](https://github.com/RevenueCat/purchases-android/releases/tag/10.13.0)
  * [iOS 5.80.3](https://github.com/RevenueCat/purchases-ios/releases/tag/5.80.3)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.19.1 (#996) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump xcodeproj from 1.27.0 to 1.28.1 (#1001) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.236.1 to 2.237.0 (#997) via dependabot[bot] (@dependabot[bot])

## 8.0.10
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.19.0 (#994) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.18.0 (#990) via RevenueCat Git Bot (@RCGitBot)

## 8.0.9
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.17.0 (#989) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Bump faraday from 1.10.5 to 1.10.6 (#992) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `70bf5c7` to `dab6765` (#991) via dependabot[bot] (@dependabot[bot])
* Use mise for JDK management (#986) via Álvaro Brey (@AlvaroBrey)
* Bump nokogiri from 1.19.3 to 1.19.4 (#985) via dependabot[bot] (@dependabot[bot])
* Bump danger from 9.5.3 to 9.6.0 (#984) via dependabot[bot] (@dependabot[bot])
* Update sdks-common-config orb to 3.21.2 (#983) via Antonio Pallares (@ajpallares)

## 8.0.8
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.15.1 (#980) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* chore: Add 3-day Dependabot cooldown, excluding fastlane plugin (#981) via Toni Rico (@tonidero)
* Bump fastlane-plugin-revenuecat_internal from `ce6a7ef` to `70bf5c7` (#978) via dependabot[bot] (@dependabot[bot])
* Fix plugin-installation-test hang by using preinstalled CocoaPods (#979) via Antonio Pallares (@ajpallares)
* Bump fastlane from 2.236.0 to 2.236.1 (#974) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.235.0 to 2.236.0 (#972) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.9.1 (#965) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `af7bb5c` to `ce6a7ef` (#967) via dependabot[bot] (@dependabot[bot])

## 8.0.5
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.8.0 (#961) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.7.1 (#960) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane from 2.234.0 to 2.235.0 (#962) via dependabot[bot] (@dependabot[bot])

## 8.0.4
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.7.0 (#958) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.3.0 (#948) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 18.2.0 (#946) via RevenueCat Git Bot (@RCGitBot)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `21e02ec` to `af7bb5c` (#950) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `2d11430` to `21e02ec` (#949) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `d24ab26` to `2d11430` (#947) via dependabot[bot] (@dependabot[bot])
* Replace unauthenticated SDKMAN install with SHA-pinned orb command (#944) via Rick (@rickvdl)
* Bump fastlane from 2.233.0 to 2.233.1 (#945) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `b822f01` to `d24ab26` (#943) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.46.1 (#875) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.46.0 (#873) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.23.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.1)
  * [Android 9.23.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.0)
  * [iOS 5.61.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.61.0)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.45.0 (#870) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.23.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.1)
  * [Android 9.23.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.0)
  * [iOS 5.61.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.61.0)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.44.0 (#868) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.23.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.1)
  * [Android 9.23.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.23.0)
  * [iOS 5.61.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.61.0)

### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `f5c099b` to `e146447` (#872) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `8cd957f` to `f5c099b` (#866) via dependabot[bot] (@dependabot[bot])

## 7.3.2
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.42.0 (#863) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Fix docs-deploy by using SSH URL instead of HTTPS (#862) via Antonio Pallares (@ajpallares)
* Update sdks-common-config orb to 3.13.0 (#861) via Cesar de la Vega (@vegaro)
* Bump fastlane from 2.232.1 to 2.232.2 (#860) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `ea6276c` to `8cd957f` (#856) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* Updates purchases-hybrid-common to 17.33.1 (#835) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.32.0 (#832) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.20.2](https://github.com/RevenueCat/purchases-android/releases/tag/9.20.2)
  * [Android 9.20.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.20.1)
  * [iOS 5.57.2](https://github.com/RevenueCat/purchases-ios/releases/tag/5.57.2)
  * [iOS 5.57.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.57.1)
...
### 🔄 Other Changes
* Bump fastlane from 2.232.0 to 2.232.1 (#836) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.231.1 to 2.232.0 (#834) via dependabot[bot] (@dependabot[bot])

## 7.2.16
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.31.0 (#830) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.28.1 (#819) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.28.0 (#817) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.19.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.19.1)
  * [Android 9.19.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.19.0)
  * [iOS 5.55.2](https://github.com/RevenueCat/purchases-ios/releases/tag/5.55.2)
  * [iOS 5.55.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.55.1)
...
### 🔄 Other Changes
* Bump fastlane from 2.231.0 to 2.231.1 (#820) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.230.0 to 2.231.0 (#818) via dependabot[bot] (@dependabot[bot])

## 7.2.13
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.26.1 (#813) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.26.0 (#810) via RevenueCat Git Bot (@RCGitBot)
  * [iOS 5.52.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.52.0)

### 🔄 Other Changes
* Bump uri from 1.0.3 to 1.0.4 (#811) via dependabot[bot] (@dependabot[bot])

## 7.2.11
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.25.0 (#807) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `76a3a08` to `e6454e3` (#808) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.229.1 to 2.230.0 (#806) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.24.0 (#803) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.23.0 (#800) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `efca663` to `76a3a08` (#801) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.21.1 (#794) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Update jobs xcode to 16.4 (#797) via Toni Rico (@tonidero)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.21.0 (#792) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.20.0 (#790) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.15.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.15.0)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
  * [iOS 5.49.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.49.0)

### 🔄 Other Changes
* Bump fastlane from 2.229.0 to 2.229.1 (#791) via dependabot[bot] (@dependabot[bot])
* Bump fastlane-plugin-revenuecat_internal from `083ced9` to `efca663` (#788) via dependabot[bot] (@dependabot[bot])
* Bump fastlane from 2.228.0 to 2.229.0 (#789) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.19.1 (#785) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.19.0 (#784) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.14.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.1)
  * [Android 9.14.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.14.0)
  * [iOS 5.48.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.48.0)
  * [iOS 5.47.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.47.1)
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.16.0 (#773) via RevenueCat Git Bot (@RCGitBot)
...
## RevenueCat SDK
### ✨ New Features
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.10.0 (#758) via RevenueCat Git Bot (@RCGitBot)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.9.1 (#756) via RevenueCat Git Bot (@RCGitBot)
  * [Android 9.9.0](https://github.com/RevenueCat/purchases-android/releases/tag/9.9.0)
  * [Android 9.8.1](https://github.com/RevenueCat/purchases-android/releases/tag/9.8.1)
  * [iOS 5.43.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.43.0)
  * [iOS 5.42.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.42.0)
...
### 🔄 Other Changes
* Bump fastlane-plugin-revenuecat_internal from `3f7fffc` to `25c7fb8` (#757) via dependabot[bot] (@dependabot[bot])
...
## RevenueCat SDK
### 📦 Dependency Updates
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 17.7.0 (#732) via RevenueCat Git Bot (@RCGitBot)
...
### 🔄 Other Changes
* Update fastlane-plugin-revenuecat_internal revision (#730) via Cesar de la Vega (@vegaro)
...
### 🔄 Other Changes
* Bump fastlane from 2.227.2 to 2.228.0 (#673) via dependabot[bot] (@dependabot[bot])
* Add warning on CHANGELOG (#703) via Toni Rico (@tonidero)
* Improve 7.0.0 changelog (#701) via Toni Rico (@tonidero)
...
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 13.29.1 (#661) via RevenueCat Git Bot (@RCGitBot)
  ...
  * [iOS 5.21.2](https://github.com/RevenueCat/purchases-ios/releases/tag/5.21.2)
  * [iOS 5.21.1](https://github.com/RevenueCat/purchases-ios/releases/tag/5.21.1)
* [AUTOMATIC BUMP] Updates purchases-hybrid-common to 13.28.1 (#656) via RevenueCat Git Bot (@RCGitBot)
  * [Android 8.17.1](https://github.com/RevenueCat/purchases-android/releases/tag/8.17.1)
  * [Android 8.17.0](https://github.com/RevenueCat/purchases-android/releases/tag/8.17.0)
  * [Android 8.16.1](https://github.com/RevenueCat/purchases-android/releases/tag/8.16.1)
  * [iOS 5.24.0](https://github.com/RevenueCat/purchases-ios/releases/tag/5.24.0)
