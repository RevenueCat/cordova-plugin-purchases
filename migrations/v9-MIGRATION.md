...
Projects upgrading from 8.x keep the Podfile CocoaPods created for them. If no other plugin contributes pods, it is inert, and `cordova platform rm ios && cordova platform add ios@8` clears it if you want CocoaPods out of the project entirely.
